...
extensions = ["sphinx.ext.autodoc", "sphinx.ext.intersphinx", "sphinx.ext.graphviz"]
...
# documentation.
html_theme_options = {"github_fork": "pallets-eco/flask-principal", "index_logo": False}
...
man_pages = [
    ("index", "flask-principal", "Flask-Principal Documentation", ["Matt Wright"], 1)
]
